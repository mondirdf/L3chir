...
const links = [
  { name: 'YouTube', icon: Youtube, href: 'https://youtube.com/@l3chiiir-j1r?si=GsErOCI5SHAR9wqz' },
  { name: 'Instagram', icon: Instagram, href: 'https://www.instagram.com/l3chiiiir?igsh=MTRoMTFuNnRieDd4bQ==' },
  { name: 'TikTok', icon: Music2, href: 'https://www.tiktok.com/@l3chiiir?_r=1&_t=ZS-94nRWhDifzM' }
];
